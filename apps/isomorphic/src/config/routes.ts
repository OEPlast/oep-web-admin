export const routes = {
  eCommerce: {
    ...
    flashSales: '/ecommerce/flash-sales',
    createFlashSale: '/ecommerce/flash-sales/create',
    flashSaleDetails: (id: string) => `/ecommerce/flash-sales/${id}`,
    editFlashSale: (id: string) => `/ecommerce/flash-sales/${id}/edit`,
