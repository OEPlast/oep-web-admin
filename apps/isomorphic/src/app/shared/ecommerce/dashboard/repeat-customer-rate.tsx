...
export default function CustomerRetentionRate({
  className,
}: {
  className?: string;
}) {
    ...
    <WidgetCard
      ...
      description={
        <>
          ...
          <Badge renderAsDot className="me-1 ms-4 bg-[#f20404]" /> Deactivated{' '}
          <Text as="span" className="hidden xs:inline-flex">
            Accounts
          </Text>
        </>
            ...
            >
              <defs>
                ...
                <linearGradient id="oldCustomer" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#fedbdb" stopOpacity={0.1} />
                  <stop offset="95%" stopColor="#fa3838" stopOpacity={0} />
                </linearGradient>
              </defs>
